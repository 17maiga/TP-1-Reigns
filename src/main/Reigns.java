...
public class Reigns {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(personnage.getGenre().getMessageRegne() + " " + personnage.getNom());
    ...
    private static void initPersonnage() {
        ...
        Genre roiReine = genre == 1 ? Genre.ROI : Genre.REINE;
    ...
    private static void initBanqueQuestions() {
        ...
        Question question1 = new Question("Main du roi", "Le peuple souhaite libérer les prisonniers", "Oui", "Non");
        ...
        Question question2 = new Question("Paysan", "Il n'y a plus rien à manger", "Importer de la nourriture",
                "Ne rien faire");
        ...
        Question question3 = new Question("Prêtre", "Les dieux sont en colère", "Faire un sacrifice", "Ne rien faire");
        ...
        Question question4 = new Question("Main du roi", "Le roi Baratheon rassemble son armée", "Le soutenir",
                "Rester neutre");
        ...
        Question question5 = new Question("Paysan", "Abondance de récoltes cette année", "Taxer énormément",
